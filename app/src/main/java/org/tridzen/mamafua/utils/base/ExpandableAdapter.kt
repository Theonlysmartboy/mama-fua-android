 ...
 * @author Mobin Munir
 */
abstract class ExpandableAdapter<ExpandedType : Any, ExpandableType : ExpandableAdapter.ExpandableGroup<ExpandedType>, PVH : ExpandableAdapter.ExpandableViewHolder, CVH : ExpandableAdapter.ExpandedViewHolder>
